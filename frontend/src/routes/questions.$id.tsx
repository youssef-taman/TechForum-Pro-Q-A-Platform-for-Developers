      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex flex-col items-center gap-1 pt-0.5">
          <button
            ...
            title={ownComment ? "Cannot vote your own comment" : "Upvote"}
          ...
          <button
            ...
            disabled={votingComments[comment.id] || ownComment}
            title={ownComment ? "Cannot vote your own comment" : "Downvote"}
...
function QuestionDetail() {
  ...
  //         try {
  //             if (author) {
  //                 setThread(await apiFetch<Thread>(API_ENDPOINTS.threadExpand(author, id)));
  //                 return;
  //             }
  //             const searchPage = await apiFetch<Page<Thread>>(...);
  //             ... (all that pagination logic)
  //         }
  //     };
  //     load();
  // }, [id, author]);
