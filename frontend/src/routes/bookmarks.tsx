...
function BookmarksPage() {
    ...
    const removeBulk = async () => {
        ...
        try {
            ...
            setBookmarks((prev) =>
                prev.filter((b) => !selected.has(b.threadId)),
            );
            toast.success(
    ...
    const filtered = bookmarks
        .filter((b) =>
            b.threadTitle.toLowerCase().includes(query.toLowerCase()),
        )
        .sort((a, b) => {
            if (sort === "newest")
                return (
            ...
            if (sort === "za")
                return b.threadTitle.localeCompare(a.threadTitle);
            return 0;
        });
